function Footer() {
  ...
  <footer className="text-center text-lg-start bg-dark text-white">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
     <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
        ...
        <p className="contact-info font-weight-normal"> Email: apaulo2035@gmail.com</p>
    </div>
  ...
  <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
        ...
        <p className="contact-info font-weight-normal"> Text: 218-395-0528</p>
    </div>
    
    <a href="https://www.linkedin.com/in/paul-amago/">
    ...
    <div className="text-center text-white p-3">
      © 2024 Copyright: Paul Amago Website
    </div>
  </footer>
    )
}    
